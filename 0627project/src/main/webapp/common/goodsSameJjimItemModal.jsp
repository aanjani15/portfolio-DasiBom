...
<!-- 로그인 모달 -->
<div id="goodsSameJjimItemModal" class="login-modal-overlay">
	<div class="login-modal">
		<h2>이미 같은 상품이 찜 목록에 있습니다. 찜 목록으로 이동하시겠습니까?</h2>
		<div class="modal-buttons">
			<button type="button" class="cancel-btn" onclick="goToJjim()">찜 목록으로 이동</button>
			<button type="button" class="confirm-btn" onclick="closeGoodsSameJjimItemModal()">쇼핑 계속하기</button>
		</div>
	</div>
</div>
	
<script>
	function closeGoodsSameJjimItemModal() {
		document.getElementById("goodsSameJjimItemModal").style.display = "none";
	}
	function goToJjim() {
		document.getElementById("goodsSameJjimItemModal").style.display = "none";
