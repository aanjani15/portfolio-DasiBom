...
<!-- 로그인 모달 -->
<div id="jjimModal" class="login-modal-overlay">
	<div class="login-modal">
		<h2>성공적으로 찜 했습니다! 찜 목록으로 이동하겠습니까?</h2>
		<div class="modal-buttons">
			<button type="button" class="cancel-btn" onclick="goToJjim()">찜 목록으로 이동</button>
			<button type="button" class="confirm-btn" onclick="closeJjimModal()">쇼핑 계속하기</button>
		</div>
	</div>
</div>
	
<script>
	function closeJjimModal() {
		document.getElementById("jjimModal").style.display = "none";
	}
	function goToJjim() {
		document.getElementById("jjimModal").style.display = "none";
